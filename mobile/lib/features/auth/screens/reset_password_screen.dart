...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> {
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      // Replace with your asset image asset when ready
                      CircleAvatar(
                        radius: 18,
                        backgroundColor: brandGreen.withAlpha(30),
                        child: const Icon(Icons.restaurant_menu, size: 18, color: brandGreen),
                      ),
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'NEW PASSWORD',
                            style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.black87, letterSpacing: 0.5),
                          ),
                          ...
                          _buildRequirementRow('At least 8 characters long', _isLongEnough, brandGreen),
                          const SizedBox(height: 8),
                          _buildRequirementRow('Contain at least one number or symbol', _hasNumberOrSymbol, brandGreen),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                if (_formKey.currentState!.validate() && _isLongEnough && _hasNumberOrSymbol) {
  ...
  InputDecoration _buildInputDecoration({
    ...
    return InputDecoration(
      hintText: hint,
      hintStyle: const TextStyle(color: Colors.black38, fontSize: 13, letterSpacing: 0.5),
